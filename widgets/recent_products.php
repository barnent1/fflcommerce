 ...
 */
class FFLCommerce_Widget_Recent_Products extends WP_Widget
{
	/**
	 * Constructor
	...
	public function __construct()
	{
		$options = array(
			...
			'description' => __("The most recent products on your site", 'fflcommerce')
		);

		parent::__construct('recent-products', __('FFL Commerce: New Products', 'fflcommerce'), $options);
	...
	public function form($instance)
	{
		...
		echo '<label for="'.esc_attr($this->get_field_id('show_variations')).'"> '.__('Show hidden product variations', 'fflcommerce').'</label>';
		echo '</p>';
	}
}
