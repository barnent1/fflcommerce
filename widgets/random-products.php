 ...
 */
class FFLCommerce_Widget_Random_Products extends WP_Widget
{
	/**
	 * Constructor
	...
	{
		$options = array(
			'classname' => 'fflcommerce_random_products',
			'description' => __('Lists a random selection of products on your site.', 'fflcommerce'),
		);

		// Create the widget
		parent::__construct('fflcommerce_random_products', __('FFL Commerce: Random Products', 'fflcommerce'), $options);
	}
	...
	public function widget($args, $instance)
	{
		...
		$title = apply_filters(
			'widget_title',
			($instance['title']) ? $instance['title'] : __('Random Products', 'fflcommerce'),
			$instance,
			$this->id_base
		);
