 ...
 */
class FFLCommerce_Widget_Featured_Products extends WP_Widget
{
	/**
	 * Constructor
	...
	{
		$options = array(
			'classname' => 'fflcommerce_featured_products',
			'description' => __('Featured products on your site', 'fflcommerce')
		);

		// Create the widget
		parent::__construct('fflcommerce_featured_products', __('FFL Commerce: Featured Products', 'fflcommerce'), $options);
	}
	...
	function widget($args, $instance)
	{
		...
		$title = apply_filters(
			'widget_title',
			($instance['title']) ? $instance['title'] : __('Featured Products', 'fflcommerce'),
			$instance,
			$this->id_base
		);
