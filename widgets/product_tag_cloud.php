 ...
 */
class FFLCommerce_Widget_Tag_Cloud extends WP_Widget
{
	/**
	 * Constructor
	...
	{
		$options = array(
			'description' => __("Your most used product tags in cloud format", 'fflcommerce'),
		);

		// Create the widget
		parent::__construct('product_tag_cloud', __('FFL Commerce: Product Tag Cloud', 'fflcommerce'), $options);
	}
	...
	public function form($instance)
	{
		...
		?>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e('Title:', 'fflcommerce'); ?></label>
...
} // class FFLCommerce_Widget_Tag_Cloud
