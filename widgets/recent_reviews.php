 ...
 */
class FFLCommerce_Widget_Recent_Reviews extends WP_Widget
{
	/**
	 * Constructor
	...
	public function __construct()
	{
		$options = array(
			...
			'description' => __('Display a list of your most recent product reviews', 'fflcommerce')
		);

		parent::__construct('recent-reviews', __('FFL Commerce: Recent Reviews', 'fflcommerce'), $options);
	...
	public function widget($args, $instance)
	{
		...
		$title = apply_filters(
			'widget_title',
			($instance['title']) ? $instance['title'] : __('Recent Reviews', 'fflcommerce'),
			$instance,
			$this->id_base
		);
