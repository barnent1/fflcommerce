 ...
 */
class FFLCommerce_Widget_Top_Rated extends WP_Widget
{
	/**
	 * Constructor
	...
	public function __construct()
	{
		$options = array(
			...
			'description' => __('The best of the best on your site', 'fflcommerce')
		);

		parent::__construct('top-rated', __('FFL Commerce: Top Rated Products', 'fflcommerce'), $options);
	...
	public function widget($args, $instance)
	{
		...
		$title = apply_filters(
			'widget_title',
			($instance['title']) ? $instance['title'] : __('Top Rated Products', 'fflcommerce'),
			$instance,
			$this->id_base
		);
