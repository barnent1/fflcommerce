 ...
 */
class FFLCommerce_Widget_Products_On_Sale extends WP_Widget
{
	/**
	 * Constructor
	...
	public function __construct()
	{
		$options = array(
			...
			'description' => __('Display a list of products currently onsale', 'fflcommerce')
		);

		// Create the widget
		parent::__construct('products-onsale', __('FFL Commerce: Products On-Sale', 'fflcommerce'), $options);
	...
	public function widget($args, $instance)
	{
		...
		$title = apply_filters(
			'widget_title',
			($instance['title']) ? $instance['title'] : __('Special Offers', 'fflcommerce'),
			$instance,
			$this->id_base
		);
