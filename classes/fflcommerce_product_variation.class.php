 ...
 *
 * The FFL Commerce product variation class handles product variation data.
 *
 * DISCLAIMER
 *
 ...
 */
class fflcommerce_product_variation extends fflcommerce_product {
	...
	public function get_price() {
		...
		if ( $this->is_on_sale() ) {
			...
			$price = apply_filters('fflcommerce_product_get_regular_price', $this->regular_price, $this->variation_id);
		}
		return apply_filters( 'fflcommerce_product_get_price', $price, $this->variation_id );
