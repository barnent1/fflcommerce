<?php
	/**
	 * Modified to work for FFL Commerce by
	 * Chris Christoff on 8/2/2012 of Jigoshop
	 * Changes: Removed the browser string return and added spacing. Also removed return HTML formatting.
	 *
	 * Modified to add formatted User Agent string for FFL Commerce System Info by
	 * Chris Christoff on 8/4/2012
	 * Changes: Split user string and add formatting so we can print a nicely
	 * formatted user agent string on the FFL Commerce System Info
	 *
	 * File: Browser.php
