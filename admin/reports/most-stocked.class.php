...
class FFLCommerce_Report_Most_Stocked extends FFLCommerce_Report_Stock
{
	/**
	...
	public function get_items($current_page, $per_page)
	{
		...
		$stock = absint(max($options->get('fflcommerce_notify_low_stock_amount'), 0));
		...
		$query_from = apply_filters('fflcommerce_report_most_stocked_query_from', $query_from);
