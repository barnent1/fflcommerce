...
class FFLCommerce_Report_Customers extends FFLCommerce_Admin_Report
{
	...
	public function get_chart_legend()
	{
		...
		$legend[] = array(
			'title' => sprintf(__('%s signups in this period', 'fflcommerce'), '<strong>'.sizeof($this->customers).'</strong>'),
	...
	public function customers_vs_guests()
	{
		...
		<div class="chart-container">
			...
			<ul class="pie-chart-legend">
				<li style="border-color: <?php echo $this->chart_colours['customers']; ?>"><?php _e('Customer Sales', 'fflcommerce'); ?></li>
				<li style="border-color: <?php echo $this->chart_colours['guests']; ?>"><?php _e('Guest Sales', 'fflcommerce'); ?></li>
			</ul>
		</div>
 				...
 				$.plot(
					...
					],
					{
						...
						series: {
							...
							enable_tooltip: true,
							append_tooltip: "<?php echo ' ' . __( 'orders', 'fflcommerce' ); ?>"
						},
						legend: {
							show: false
						}
		...
		<script type="text/javascript">
			...
			jQuery(function($){
				...
				var drawGraph = function(highlight){
					var series = [
						{
							label: "<?php echo esc_js( __( 'Customer Orders', 'fflcommerce' ) ) ?>",
							...
							shadowSize: 0,
							enable_tooltip: true,
							append_tooltip: "<?php echo ' ' . __( 'customer orders', 'fflcommerce' ); ?>",
							stack: true
						},
						{
							label: "<?php echo esc_js( __( 'Guest Orders', 'fflcommerce' ) ) ?>",
							...
							shadowSize: 0,
							enable_tooltip: true,
							append_tooltip: "<?php echo ' ' . __( 'guest orders', 'fflcommerce' ); ?>",
							stack: true
						},
						{
							label: "<?php echo esc_js( __( 'Signups', 'fflcommerce' ) ) ?>",
							...
							shadowSize: 0,
							enable_tooltip: true,
							append_tooltip: "<?php echo ' ' . __( 'new users', 'fflcommerce' ); ?>",
							stack: false
						}
					];
