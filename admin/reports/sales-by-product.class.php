...
class FFLCommerce_Report_Sales_By_Product extends FFLCommerce_Admin_Report
{
	...
	public function get_chart_legend()
	{
		...
		$legend[] = array(
			'title' => sprintf(__('%s sales for the selected items', 'fflcommerce'), '<strong>'.fflcommerce_price($total_sales).'</strong>'),
			'color' => $this->chart_colours['sales_amount'],
			'highlight_series' => 2
		);

		$legend[] = array(
			'title' => sprintf(__('%s purchases for the selected items', 'fflcommerce'), '<strong>'.$total_items.'</strong>'),
			'color' => $this->chart_colours['item_count'],
			'highlight_series' => 1
		);

		$legend[] = array(
			'title' => sprintf(__('%s purchased quantity', 'fflcommerce'), '<strong>'.$total_quantity.'</strong>'),
	...
	public function get_chart_widgets()
	{
		...
		if (!empty($this->product_ids)) {
			$widgets[] = array(
				'title' => __('Showing reports for:', 'fflcommerce'),
	...
	public function products_widget() {
		?>
		<h4 class="section_title"><span><?php _e('Product Search', 'fflcommerce'); ?></span></h4>
		<div class="section">
			<form method="GET">
				<div>
					<input type="hidden" class="fflcommerce-product-search" style="width:203px;" name="product_ids[]" data-placeholder="<?php _e('Search for a product&hellip;', 'fflcommerce'); ?>" data-action="fflcommerce_json_search_products_and_variations" />
		...
		<h4 class="section_title"><span><?php _e('Top Sellers', 'fflcommerce'); ?></span></h4>
		<div class="section">
			<table cellspacing="0">
				<?php
		...
		<h4 class="section_title"><span><?php _e('Top Freebies', 'fflcommerce'); ?></span></h4>
		<div class="section">
			<table cellspacing="0">
				<?php
		...
		<h4 class="section_title"><span><?php _e('Top Earners', 'fflcommerce'); ?></span></h4>
		<div class="section">
			<table cellspacing="0">
				<?php
	...
	public function get_export_button()
	{
		...
		?>
		<a href="#" download="report-<?php echo esc_attr($current_range); ?>-<?php echo date_i18n('Y-m-d', current_time('timestamp')); ?>.csv" class="export_csv" data-export="chart" data-xaxes="<?php _e('Date', 'fflcommerce'); ?>" data-groupby="<?php echo $this->chart_groupby; ?>">
	...
	public function get_main_chart()
	{
		...
		if (!$this->product_ids) {
			...
			<div class="chart-container">
				<p class="chart-prompt"><?php _e('&larr; Choose a product to view stats', 'fflcommerce'); ?></p>
			</div>
		<?php
		} else {
			...
			<script type="text/javascript">
				...
				jQuery(function($){
					...
					var drawGraph = function(highlight){
						var series = [
							{
								label: "<?php echo esc_js(__('Sold quantity', 'fflcommerce')) ?>",
							...
							{
								label: "<?php echo esc_js(__('Sales amount', 'fflcommerce')) ?>",
