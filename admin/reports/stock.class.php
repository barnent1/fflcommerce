...
class FFLCommerce_Report_Stock extends WP_List_Table
{
	public function __construct()
	{
		parent::__construct(array(
			'singular' => __('Stock', 'fflcommerce'),
			'plural' => __('Stock', 'fflcommerce'),
			'ajax' => false
		));
	}
	...
	{
		_e('No products found.', 'fflcommerce');
	}
	...
	public function prepare_items()
	{
		...
		$per_page = apply_filters('fflcommerce_admin_stock_report_products_per_page', 20);
	...
	public function get_columns()
	{
		...
		$columns = array(
			'product' => __('Product', 'fflcommerce'),
			'parent' => __('Parent', 'fflcommerce'),
			'stock_level' => __('Units in stock', 'fflcommerce'),
			'stock_status' => __('Stock status', 'fflcommerce'),
			'actions' => __('Actions', 'fflcommerce'),
		);
