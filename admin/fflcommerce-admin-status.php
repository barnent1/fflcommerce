...
class FFLCommerce_Admin_Status
{
	public static function output()
	{
		$template = fflcommerce_locate_template('admin/status/main');
	...
	{
		$template = fflcommerce_locate_template('admin/status/report');
		/** @noinspection PhpIncludeInspection */
		include($template);
	}
	...
	public static function get_tools()
	{
		$tools = array(
			'clear_transients' => array(
				'name' => __('FFL Commerce Transients', 'fflcommerce'),
				'button' => __('Clear transients', 'fflcommerce'),
				'desc' => __('This tool will clear the product/shop transients cache.', 'fflcommerce'),
			),
			'clear_expired_transients' => array(
				'name' => __('Expired Transients', 'fflcommerce'),
				'button' => __('Clear expired transients', 'fflcommerce'),
				'desc' => __('This tool will clear ALL expired transients from WordPress.', 'fflcommerce'),
			),
			'recount_terms' => array(
				'name' => __('Term counts', 'fflcommerce'),
				'button' => __('Recount terms', 'fflcommerce'),
				'desc' => __('This tool will recount product terms - useful when changing your settings in a way which hides products from the catalog.', 'fflcommerce'),
			),
			'reset_roles' => array(
				'name' => __('Capabilities', 'fflcommerce'),
				'button' => __('Reset capabilities', 'fflcommerce'),
				'desc' => __('This tool will reset the admin, customer and shop_manager roles to default. Use this if your users cannot access all of the FFL Commerce admin pages.', 'fflcommerce'),
			),
			'delete_taxes' => array(
				'name' => __('Delete all FFL Commerce tax rates', 'fflcommerce'),
				'button' => __('Delete ALL tax rates', 'fflcommerce'),
				'desc' => __('<strong class="red">Note:</strong> This option will delete ALL of your tax rates, use with caution.', 'fflcommerce'),
			),
		);

		return apply_filters('fflcommerce_debug_tools', $tools);
	}
	...
	{
		$files = @scandir(FFLCOMMERCE_LOG_DIR);
		$result = array();
